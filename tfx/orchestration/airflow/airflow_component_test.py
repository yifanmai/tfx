...
class AirflowComponentTest(tf.test.TestCase):
  ...
  def testAirflowAdaptor(self):
    ...
    mock_component_launcher_class.from_component.return_value = mock_component_launcher
    airflow_component._airflow_component_launcher(
        ...
        ti=mock_ti)
    mock_component_launcher_class.from_component.assert_called_once()
    arg_list = mock_component_launcher_class.from_component.call_args_list
