...
"""Python source file include flowers pipeline functions and necesasry utils.
...
This file is equivalent to examples/flowers/trainer/model.py and
examples/flowers/preprocess.py.
"""
...
def trainer_fn(hparams, schema):
  ...
  exporter = tf.estimator.FinalExporter('flowers', serving_receiver_fn)
