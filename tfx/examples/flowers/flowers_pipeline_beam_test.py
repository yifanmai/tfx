...
"""Tests for tfx.examples.flowers.flowers_pipeline_beam."""
...
from tfx.examples.flowers import flowers_pipeline_beam
...
class FlowersPipelineBeamTest(tf.test.TestCase):
  ...
  def testFlowersPipelineCheckDagConstruction(self):
    logical_pipeline = flowers_pipeline_beam._create_pipeline(
        pipeline_name='Test',
